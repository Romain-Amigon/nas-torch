...
if __name__ == "__main__":
    ...
    for current_seed in seeds:
        ...
        opt_abc = ABCOptimizer(layers=initial_arch , dataset=train_loader_proxy, limit=5, patience=5)
    ...
    with open("results/academic_results_ABC_30.json", "w", encoding="utf-8") as f:
        json.dump(all_results, f, indent=4)

    with open("results/academic_summary_ABC_30.txt", "w", encoding="utf-8") as f:
